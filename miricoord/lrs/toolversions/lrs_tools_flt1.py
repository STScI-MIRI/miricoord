...
This contains FLT-1 specific code.
For LRS, FLT-1 wavelength solution uses the FLT-1 Imager distortion.
...
def get_fitsreffile():
    basefile='data/fits/flt1/MIRI_FM_MIRIMAGE_P750L_DISTORTION_9B.00.05.fits'
