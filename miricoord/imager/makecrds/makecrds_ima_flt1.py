...
MIRI Imager using IDT reference files for initial flight solution FLT-1.

MIRI_FM_MIRIMAGE_DISTORTION_SS.04.00.fits
...
def make_filter_offset(distfile, outname):
    ...
    Examples
    -------
    >>> make_filter_offset('MIRI_FM_MIRIMAGE_DISTORTION_SS.04.00.fits',
    ...
    model.meta.title = "MIRI imager filter offset - FLT1"
    model.meta.description = "FLT1 delivery"
...
def make_distortion(distfile, outname):
    ...
    dist.meta.title = "MIRI imager distortion - FLT1"
    dist.meta.description = "FLT1 delivery"
...
def make_references(filename, ref):
    ...
    filename : str
        ...
        In FLT1 the file is called "MIRI_FM_MIRIMAGE_DISTORTION_SS.04.00.fits"
    ref : dict
    ...
    Examples
    --------
    >>> make_references('MIRI_FM_MIRIMAGE_DISTORTION_SS.04.00.fits',
        {'DISTORTION': 'jwst_miri_distortion_0001.asdf',
...
def test_transform(refs):
    ...
    refs: refs = {"distortion": distfile, "filteroffset": offfile}
        distfile="jwst_miri_imager_distortion_flt1.asdf"
        offfile="jwst_miri_filteroffset_flt1.asdf"

    xy, v2, v3 values are from hand computation from FLT-1 delivery
