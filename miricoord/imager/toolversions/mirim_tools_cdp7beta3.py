...
def get_fitsreffile():
    ...
    reffile=os.path.join(rootdir,'data/fits/cdp7beta3/MIRI_FM_MIRIMAGE_DISTORTION_7B.03.00.fits')
...
def v2v3toxy(v2in,v3in,filter):
    ...
    Xin = np.array([UnitVec,EFP_X,EFP_X**2,EFP_X**3,EFP_X**4])
    Yin = np.array([UnitVec,EFP_Y,EFP_Y**2,EFP_Y**3,EFP_Y**4])
