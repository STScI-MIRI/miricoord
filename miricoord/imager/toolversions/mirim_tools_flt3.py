...
This contains flt3 specific code.

FLT-3 is just like FLT-1, except that it adds coron-specific
boresight offset tables.
...
def get_fitsreffile():
    basefile='data/fits/flt3/MIRI_FM_MIRIMAGE_DISTORTION_SS.06.00.fits'
