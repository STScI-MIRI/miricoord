...
MIRI MRS using reference files delivered with FLT-6:

Note FLT-6 only changed wavelength solution for 1A/1B from FLT-5.

MIRI_FM_MIRIFULONG_34LONG_DISTORTION_FLT5.fits
MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_FLT6.fits
MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_FLT5.fits
MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_FLT6.fits
MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_FLT5.fits
MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_FLT5.fits
...
def create_flt6_all(outdir, **kwargs):
    # Regular grating wheel configurations
    detbands='12A','12B','12C','34A','34B','34C'
    nbands=len(detbands)
    for i in range(nbands):
        create_flt6_setfiles(detbands[i],outdir,**kwargs)
    ...
    #    create_flt6_setxfiles(xbands[i],outdir,**kwargs)
...
def create_flt6_setfiles(detband,outdir, **kwargs):
    rootdir=os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    rootdir=os.path.join(rootdir,'data/fits/flt6/')

    if (detband == '12A'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt6.fits')
    elif (detband == '34A'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt6.fits')
    elif (detband == '12B'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt6.fits')
    elif (detband == '34B'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt6.fits')
    elif (detband == '12C'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt6.fits')
    elif (detband == '34C'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_flt6.fits')

    distfile=outdir+'jwst_miri_mrs'+detband+'_distortion_flt6.asdf'
    regfile=outdir+'jwst_miri_mrs'+detband+'_regions_flt6.asdf'
    specfile=outdir+'jwst_miri_mrs'+detband+'_specwcs_flt6.asdf'
    wavefile=outdir+'jwst_miri_mrs_wavelengthrange_flt6.asdf'
    refs={'distortion': distfile, 'regions':regfile, 'specwcs':specfile, 'wavelengthrange':wavefile}
    print('Working on: '+detband)
    create_flt6_onereference(fname,refs,**kwargs)
    print('Testing: '+detband)
    test_flt6_onereference(detband,refs)
...
def create_flt6_setxfiles(detxband,outdir,**kwargs):
    rootdir=os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    rootdir=os.path.join(rootdir,'data/fits/flt6/')

    if (detxband == '12AB'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt6.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt6.fits')
    elif (detxband == '12AC'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt6.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt6.fits')
    elif (detxband == '12BA'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt6.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt6.fits')
    elif (detxband == '12BC'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt6.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt6.fits')
    elif (detxband == '12CA'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt6.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt6.fits')
    elif (detxband == '12CB'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt6.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt6.fits')
    ...
    # '34AB' means 3B+4A
        ...
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt6.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt6.fits')
    elif (detxband == '34AC'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt6.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_flt6.fits')
    elif (detxband == '34BA'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt6.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt6.fits')
    elif (detxband == '34BC'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt6.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_flt6.fits')
    elif (detxband == '34CA'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_flt6.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt6.fits')
    elif (detxband == '34CB'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_flt6.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt6.fits')

    distfile=outdir+'jwst_miri_mrs'+detxband+'_distortion_flt6.asdf'
    regfile=outdir+'jwst_miri_mrs'+detxband+'_regions_flt6.asdf'
    specfile=outdir+'jwst_miri_mrs'+detxband+'_specwcs_flt6.asdf'
    wavefile=outdir+'jwst_miri_mrs_wavelengthrange_flt6.asdf'
    refs={'distortion': distfile, 'regions':regfile, 'specwcs':specfile, 'wavelengthrange':wavefile}
    print('Working on: '+detxband)
    create_flt6_onexreference(fname1,fname2,refs,**kwargs)
    print('Created: '+detxband)

    
#############################
    
def create_flt6_onereference(fname, ref, **kwargs):
    """
    ...
    Examples
    --------
    >>> create_flt6_references('MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt6.fits', ref)
    """
...
def create_flt6_onexreference(fname1, fname2, ref, **kwargs):
    """
...
# Detband is (e.g.) '12A'
def test_flt6_onereference(detband,refs):
