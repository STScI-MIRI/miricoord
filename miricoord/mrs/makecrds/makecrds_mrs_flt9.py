...
MIRI MRS using reference files delivered with FLT-9:

FLT-9 changes the entire MRS boresight to match a shift applied to the MIRI imager
for FLT-9, based on new analysis registering against FGS.

MIRI_FM_MIRIFULONG_34LONG_DISTORTION_FLT9.fits
MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_FLT9.fits
MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_FLT9.fits
MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_FLT9.fits
MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_FLT9.fits
MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_FLT9.fits
...
23-Jul-2025  FLT-9 update to boresight (D. Law)
"""
...
def create_flt9_all(outdir, **kwargs):
    # Regular grating wheel configurations
    detbands='12A','12B','12C','34A','34B','34C'
    nbands=len(detbands)
    for i in range(nbands):
        create_flt9_setfiles(detbands[i],outdir,**kwargs)
    ...
    #    create_flt9_setxfiles(xbands[i],outdir,**kwargs)
...
def create_flt9_setfiles(detband,outdir, **kwargs):
    rootdir=os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    rootdir=os.path.join(rootdir,'data/fits/flt9/')

    if (detband == '12A'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt9.fits')
    elif (detband == '34A'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt9.fits')
    elif (detband == '12B'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt9.fits')
    elif (detband == '34B'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt9.fits')
    elif (detband == '12C'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt9.fits')
    elif (detband == '34C'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_flt9.fits')

    distfile=outdir+'jwst_miri_mrs'+detband+'_distortion_flt9.asdf'
    regfile=outdir+'jwst_miri_mrs'+detband+'_regions_flt9.asdf'
    specfile=outdir+'jwst_miri_mrs'+detband+'_specwcs_flt9.asdf'
    wavefile=outdir+'jwst_miri_mrs_wavelengthrange_flt9.asdf'
    refs={'distortion': distfile, 'regions':regfile, 'specwcs':specfile, 'wavelengthrange':wavefile}
    print('Working on: '+detband)
    create_flt9_onereference(fname,refs,**kwargs)
    print('Testing: '+detband)
    test_flt9_onereference(detband,refs)
...
def create_flt9_setxfiles(detxband,outdir,**kwargs):
    rootdir=os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    rootdir=os.path.join(rootdir,'data/fits/flt9/')

    if (detxband == '12AB'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt9.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt9.fits')
    elif (detxband == '12AC'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt9.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt9.fits')
    elif (detxband == '12BA'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt9.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt9.fits')
    elif (detxband == '12BC'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt9.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt9.fits')
    elif (detxband == '12CA'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt9.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt9.fits')
    elif (detxband == '12CB'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt9.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt9.fits')
    ...
    # '34AB' means 3B+4A
        ...
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt9.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt9.fits')
    elif (detxband == '34AC'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt9.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_flt9.fits')
    elif (detxband == '34BA'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt9.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt9.fits')
    elif (detxband == '34BC'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt9.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_flt9.fits')
    elif (detxband == '34CA'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_flt9.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt9.fits')
    elif (detxband == '34CB'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_flt9.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt9.fits')

    distfile=outdir+'jwst_miri_mrs'+detxband+'_distortion_flt9.asdf'
    regfile=outdir+'jwst_miri_mrs'+detxband+'_regions_flt9.asdf'
    specfile=outdir+'jwst_miri_mrs'+detxband+'_specwcs_flt9.asdf'
    wavefile=outdir+'jwst_miri_mrs_wavelengthrange_flt9.asdf'
    refs={'distortion': distfile, 'regions':regfile, 'specwcs':specfile, 'wavelengthrange':wavefile}
    print('Working on: '+detxband)
    create_flt9_onexreference(fname1,fname2,refs,**kwargs)
    print('Created: '+detxband)

    
#############################
    
def create_flt9_onereference(fname, ref, **kwargs):
    """
    ...
    Examples
    --------
    >>> create_flt9_references('MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt9.fits', ref)
    """
    ...
    description = 'MIRI MRS FLT9 (flt9) distortion reference data.'
...
def create_flt9_onexreference(fname1, fname2, ref, **kwargs):
    """
...
def create_reffile_header(model, detector, band, channel, author, useafter,
    ...
    entry6 = HistoryEntry({'description': "MRS wavelength and spatial distortion.  FLT9 updates the MRS boresight in V2/V3 space to keep it consistent with the updated FLT-9 imager position.)", 'time': datetime.datetime.utcnow()})
    ...
    model.history = [entry1,entry2,entry3,entry4,entry5,entry6]
...
# Detband is (e.g.) '12A'
def test_flt9_onereference(detband,refs):
