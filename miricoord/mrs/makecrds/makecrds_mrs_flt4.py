...
MIRI MRS using reference files delivered with FLT-4:

MIRI_FM_MIRIFULONG_34LONG_DISTORTION_10.01.00.fits
MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_10.01.00.fits
MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_10.01.00.fits
MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_10.01.00.fits
MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_10.01.00.fits
MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_10.01.00.fits
...
def create_flt4_all(outdir, **kwargs):
    # Regular grating wheel configurations
    detbands='12A','12B','12C','34A','34B','34C'
    nbands=len(detbands)
    for i in range(nbands):
        create_flt4_setfiles(detbands[i],outdir,**kwargs)
    ...
    for i in range(nxbands):
        create_flt4_setxfiles(xbands[i],outdir,**kwargs)
...
def create_flt4_setfiles(detband,outdir, **kwargs):
    rootdir=os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    rootdir=os.path.join(rootdir,'data/fits/flt4/')

    if (detband == '12A'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_10.01.00.fits')
    elif (detband == '34A'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_10.01.00.fits')
    elif (detband == '12B'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_10.01.00.fits')
    elif (detband == '34B'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_10.01.00.fits')
    elif (detband == '12C'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_10.01.00.fits')
    elif (detband == '34C'):
        fname=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_10.01.00.fits')

    distfile=outdir+'jwst_miri_mrs'+detband+'_distortion_flt4.asdf'
    regfile=outdir+'jwst_miri_mrs'+detband+'_regions_flt4.asdf'
    specfile=outdir+'jwst_miri_mrs'+detband+'_specwcs_flt4.asdf'
    wavefile=outdir+'jwst_miri_mrs_wavelengthrange_flt4.asdf'
    refs={'distortion': distfile, 'regions':regfile, 'specwcs':specfile, 'wavelengthrange':wavefile}
    print('Working on: '+detband)
    create_flt4_onereference(fname,refs,**kwargs)
    print('Testing: '+detband)
    test_flt4_onereference(detband,refs)
...
def create_flt4_setxfiles(detxband,outdir,**kwargs):
    rootdir=os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    rootdir=os.path.join(rootdir,'data/fits/flt4/')

    if (detxband == '12AB'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_10.01.00.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_10.01.00.fits')
    elif (detxband == '12AC'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_10.01.00.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_10.01.00.fits')
    elif (detxband == '12BA'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_10.01.00.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_10.01.00.fits')
    elif (detxband == '12BC'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_10.01.00.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_10.01.00.fits')
    elif (detxband == '12CA'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_10.01.00.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_10.01.00.fits')
    elif (detxband == '12CB'):
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_10.01.00.fits')
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_10.01.00.fits')
    ...
    # '34AB' means 3B+4A
        ...
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_10.01.00.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_10.01.00.fits')
    elif (detxband == '34AC'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_10.01.00.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_10.01.00.fits')
    elif (detxband == '34BA'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_10.01.00.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_10.01.00.fits')
    elif (detxband == '34BC'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_10.01.00.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_10.01.00.fits')
    elif (detxband == '34CA'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_10.01.00.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_10.01.00.fits')
    elif (detxband == '34CB'):
        fname2=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34LONG_DISTORTION_10.01.00.fits')
        fname1=os.path.join(rootdir,'MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_10.01.00.fits')

    distfile=outdir+'jwst_miri_mrs'+detxband+'_distortion_flt4.asdf'
    regfile=outdir+'jwst_miri_mrs'+detxband+'_regions_flt4.asdf'
    specfile=outdir+'jwst_miri_mrs'+detxband+'_specwcs_flt4.asdf'
    wavefile=outdir+'jwst_miri_mrs_wavelengthrange_flt4.asdf'
    refs={'distortion': distfile, 'regions':regfile, 'specwcs':specfile, 'wavelengthrange':wavefile}
    print('Working on: '+detxband)
    create_flt4_onexreference(fname1,fname2,refs,**kwargs)
    print('Created: '+detxband)

    
#############################
    
def create_flt4_onereference(fname, ref, **kwargs):
    """
    ...
    Examples
    --------
    >>> create_flt4_references('MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_10.01.00.fits', ref)
    """
    ...
    description = 'MIRI MRS FLT4 (10.01.00) distortion reference data.'
...
def create_flt4_onexreference(fname1, fname2, ref, **kwargs):
    """
...
def create_reffile_header(model, detector, band, channel, author, useafter,
    ...
    entry = HistoryEntry({'description': "MRS wavelength and spatial distortion.  FLT3 updates distortion based on program 1524.  FLT4 updates wavelength calibration based on reanalysis of program 1031", 'time': datetime.datetime.utcnow()})
...
# Detband is (e.g.) '12A'
def test_flt4_onereference(detband,refs):
