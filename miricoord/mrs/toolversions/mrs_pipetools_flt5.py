...
This contains flt5 specific code.
...
def get_fitsreffile(channel):
    wavefile='jwst_miri_mrs_wavelengthrange_flt5.asdf'

    # Channel should be of the form (e.g.) '1A', '3C', etc
    if ((channel == '1A')or(channel == '2A')):
       distfile='jwst_miri_mrs12A_distortion_flt5.asdf'
       regfile='jwst_miri_mrs12A_regions_flt5.asdf'
       specfile='jwst_miri_mrs12A_specwcs_flt5.asdf'
    elif ((channel == '3A')or(channel == '4A')):
       distfile='jwst_miri_mrs34A_distortion_flt5.asdf'
       regfile='jwst_miri_mrs34A_regions_flt5.asdf'
       specfile='jwst_miri_mrs34A_specwcs_flt5.asdf'
    elif ((channel == '1B')or(channel == '2B')):
       distfile='jwst_miri_mrs12B_distortion_flt5.asdf'
       regfile='jwst_miri_mrs12B_regions_flt5.asdf'
       specfile='jwst_miri_mrs12B_specwcs_flt5.asdf'
    elif ((channel == '3B')or(channel == '4B')):
       distfile='jwst_miri_mrs34B_distortion_flt5.asdf'
       regfile='jwst_miri_mrs34B_regions_flt5.asdf'
       specfile='jwst_miri_mrs34B_specwcs_flt5.asdf'
    elif ((channel == '1C')or(channel == '2C')):
       distfile='jwst_miri_mrs12C_distortion_flt5.asdf'
       regfile='jwst_miri_mrs12C_regions_flt5.asdf'
       specfile='jwst_miri_mrs12C_specwcs_flt5.asdf'
    elif ((channel == '3C')or(channel == '4C')):
       distfile='jwst_miri_mrs34C_distortion_flt5.asdf'
       regfile='jwst_miri_mrs34C_regions_flt5.asdf'
       specfile='jwst_miri_mrs34C_specwcs_flt5.asdf'
    else:
       print('Failure!')

    # Try looking for the files in the expected location
    rootdir=os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    rootdir=os.path.join(rootdir,'data/crds/flt5/')
...
mrs_ref_data = {
    '1A': {'x': np.array([ 76., 354.]),
           ...
           'lam': np.array([5.35072375, 5.51518959]),
    ...
    '1B': {'x': np.array([ 76., 355.]),
           ...
           'lam': np.array([6.17975843, 6.3700669]),
    ...
    '4B': {'x': np.array([192., 229.]),
           ...
           'lam': np.array([22.74041478, 21.92449173]),
           'v2': np.array([-503.29190489, -502.63545381]),
           'v3': np.array([-321.67132896, -318.1059683]),
           },
    '4C': {'x': np.array([194., 231.]),
           ...
           'lam': np.array([26.60512068, 25.65160809]),
