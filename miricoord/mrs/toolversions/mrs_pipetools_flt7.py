...
This contains flt7 specific code.
...
def get_fitsreffile(channel):
    wavefile='jwst_miri_mrs_wavelengthrange_flt7.asdf'

    # Channel should be of the form (e.g.) '1A', '3C', etc
    if ((channel == '1A')or(channel == '2A')):
       distfile='jwst_miri_mrs12A_distortion_flt7.asdf'
       regfile='jwst_miri_mrs12A_regions_flt7.asdf'
       specfile='jwst_miri_mrs12A_specwcs_flt7.asdf'
    elif ((channel == '3A')or(channel == '4A')):
       distfile='jwst_miri_mrs34A_distortion_flt7.asdf'
       regfile='jwst_miri_mrs34A_regions_flt7.asdf'
       specfile='jwst_miri_mrs34A_specwcs_flt7.asdf'
    elif ((channel == '1B')or(channel == '2B')):
       distfile='jwst_miri_mrs12B_distortion_flt7.asdf'
       regfile='jwst_miri_mrs12B_regions_flt7.asdf'
       specfile='jwst_miri_mrs12B_specwcs_flt7.asdf'
    elif ((channel == '3B')or(channel == '4B')):
       distfile='jwst_miri_mrs34B_distortion_flt7.asdf'
       regfile='jwst_miri_mrs34B_regions_flt7.asdf'
       specfile='jwst_miri_mrs34B_specwcs_flt7.asdf'
    elif ((channel == '1C')or(channel == '2C')):
       distfile='jwst_miri_mrs12C_distortion_flt7.asdf'
       regfile='jwst_miri_mrs12C_regions_flt7.asdf'
       specfile='jwst_miri_mrs12C_specwcs_flt7.asdf'
    elif ((channel == '3C')or(channel == '4C')):
       distfile='jwst_miri_mrs34C_distortion_flt7.asdf'
       regfile='jwst_miri_mrs34C_regions_flt7.asdf'
       specfile='jwst_miri_mrs34C_specwcs_flt7.asdf'
    else:
       print('Failure!')

    # Try looking for the files in the expected location
    rootdir=os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    rootdir=os.path.join(rootdir,'data/crds/flt7/')
