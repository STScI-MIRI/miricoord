...
23-Jul-2025  FLT-9 update to boresight location (D. Law)
"""
...
def get_fitsreffile(channel):
    wavefile='jwst_miri_mrs_wavelengthrange_flt9.asdf'

    # Channel should be of the form (e.g.) '1A', '3C', etc
    if ((channel == '1A')or(channel == '2A')):
       distfile='jwst_miri_mrs12A_distortion_flt9.asdf'
       regfile='jwst_miri_mrs12A_regions_flt9.asdf'
       specfile='jwst_miri_mrs12A_specwcs_flt9.asdf'
    elif ((channel == '3A')or(channel == '4A')):
       distfile='jwst_miri_mrs34A_distortion_flt9.asdf'
       regfile='jwst_miri_mrs34A_regions_flt9.asdf'
       specfile='jwst_miri_mrs34A_specwcs_flt9.asdf'
    elif ((channel == '1B')or(channel == '2B')):
       distfile='jwst_miri_mrs12B_distortion_flt9.asdf'
       regfile='jwst_miri_mrs12B_regions_flt9.asdf'
       specfile='jwst_miri_mrs12B_specwcs_flt9.asdf'
    elif ((channel == '3B')or(channel == '4B')):
       distfile='jwst_miri_mrs34B_distortion_flt9.asdf'
       regfile='jwst_miri_mrs34B_regions_flt9.asdf'
       specfile='jwst_miri_mrs34B_specwcs_flt9.asdf'
    elif ((channel == '1C')or(channel == '2C')):
       distfile='jwst_miri_mrs12C_distortion_flt9.asdf'
       regfile='jwst_miri_mrs12C_regions_flt9.asdf'
       specfile='jwst_miri_mrs12C_specwcs_flt9.asdf'
    elif ((channel == '3C')or(channel == '4C')):
       distfile='jwst_miri_mrs34C_distortion_flt9.asdf'
       regfile='jwst_miri_mrs34C_regions_flt9.asdf'
       specfile='jwst_miri_mrs34C_specwcs_flt9.asdf'
    else:
       print('Failure!')

    # Try looking for the files in the expected location
    rootdir=os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    rootdir=os.path.join(rootdir,'data/crds/flt9/')
...
mrs_ref_data = {
    '1A': {'x': np.array([ 76., 354.]),
           ...
           'v2': np.array([-503.28208069, -503.206904]),
           'v3': np.array([-318.69356492, -317.62984046]),
           },    
    '1B': {'x': np.array([ 76., 355.]),
           ...
           'v2': np.array([-503.29385292, -503.02084995]),
           'v3': np.array([-318.79727361, -317.76261186]),
           },
    '1C': {'x': np.array([ 78., 356.]),
           ...
           'v2': np.array([-503.22979331, -503.12782722]),
           'v3': np.array([-318.52896198, -317.46936798]),
           },
    '2A': {'x': np.array([574., 719.]),
           ...
           'v2': np.array([-503.46501112, -503.19951886]),
           'v3': np.array([-319.42000391, -317.76259805]),
           },
    '2B': {'x': np.array([570., 715.]),
           ...
           'v2': np.array([-503.59237204, -503.32535267]),
           'v3': np.array([-319.69631641, -318.03950214]),
           },
    '2C': {'x': np.array([573., 718.]),
           ...
           'v2': np.array([-503.48367901, -503.2175601]),
           'v3': np.array([-319.62391401, -317.96658109]),
           },
    '3A': {'x': np.array([918., 827.]),
           ...
           'v2': np.array([-504.18005795, -503.96783016]),
           'v3': np.array([-319.41143366, -317.08380645]),
           },
    '3B': {'x': np.array([919., 827.]),
           ...
           'v2': np.array([-504.2700668 , -503.82498525]),
           'v3': np.array([-319.61521792, -317.31690861]),
           },
    '3C': {'x': np.array([917., 826.]),
           ...
           'v2': np.array([-504.05513011, -503.85152482]),
           'v3': np.array([-319.60778724, -317.27831155]),
           },
    '4A': {'x': np.array([195., 232.]),
           ...
           'v2': np.array([-503.26282929, -502.51749655]),
           'v3': np.array([-321.83155917, -317.97683182]),
           },
    '4B': {'x': np.array([192., 229.]),
           ...
           'v2': np.array([-503.25939738, -502.58877658]),
           'v3': np.array([-321.76179699, -317.89012988]),
           },
    '4C': {'x': np.array([194., 231.]),
           ...
           'v2': np.array([-503.29401646, -502.56831138]),
           'v3': np.array([-321.76316753, -317.86999682]),
           }
}
