...
This contains flt9 specific code.  flt9 moved the boresight by about 0.14 arcsec
for consistency with MIRI imager and FGS.
...
31-May-2023  FLT-6 update to 1A+1B wave solution (D. Law)
30-Aug-2023  FLT-7 update to 4B distortion solution (D. Law)
06-Dec-2023  FLT-8 update to 3C/4A/4B/4C wave solution (D. Law)
09-Jun-2025  FLT-9 update to boresight location (D. Law)
"""
...
def get_fitsreffile(channel):
    if (channel == '1A'):
        file='MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt9.fits'
    elif (channel == '1B'):
        file='MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt9.fits'
    elif (channel == '1C'):
        file='MIRI_FM_MIRIFUSHORT_12LONG_DISTORTION_flt9.fits'
    elif (channel == '2A'):
        file='MIRI_FM_MIRIFUSHORT_12SHORT_DISTORTION_flt9.fits'
    elif (channel == '2B'):
        file='MIRI_FM_MIRIFUSHORT_12MEDIUM_DISTORTION_flt9.fits'
        ...
        file='MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt9.fits'
    elif (channel == '3B'):
        file='MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt9.fits'
    elif (channel == '3C'):
        file='MIRI_FM_MIRIFULONG_34LONG_DISTORTION_flt9.fits'
    elif (channel == '4A'):
        file='MIRI_FM_MIRIFULONG_34SHORT_DISTORTION_flt9.fits'
    elif (channel == '4B'):
        file='MIRI_FM_MIRIFULONG_34MEDIUM_DISTORTION_flt9.fits'
