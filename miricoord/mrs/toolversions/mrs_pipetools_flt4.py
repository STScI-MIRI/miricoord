...
def get_fitsreffile(channel):
    wavefile='jwst_miri_mrs_wavelengthrange_flt4.asdf'

    # Channel should be of the form (e.g.) '1A', '3C', etc
    if ((channel == '1A')or(channel == '2A')):
       distfile='jwst_miri_mrs12A_distortion_flt4.asdf'
       regfile='jwst_miri_mrs12A_regions_flt4.asdf'
       specfile='jwst_miri_mrs12A_specwcs_flt4.asdf'
    elif ((channel == '3A')or(channel == '4A')):
       distfile='jwst_miri_mrs34A_distortion_flt4.asdf'
       regfile='jwst_miri_mrs34A_regions_flt4.asdf'
       specfile='jwst_miri_mrs34A_specwcs_flt4.asdf'
    elif ((channel == '1B')or(channel == '2B')):
       distfile='jwst_miri_mrs12B_distortion_flt4.asdf'
       regfile='jwst_miri_mrs12B_regions_flt4.asdf'
       specfile='jwst_miri_mrs12B_specwcs_flt4.asdf'
    elif ((channel == '3B')or(channel == '4B')):
       distfile='jwst_miri_mrs34B_distortion_flt4.asdf'
       regfile='jwst_miri_mrs34B_regions_flt4.asdf'
       specfile='jwst_miri_mrs34B_specwcs_flt4.asdf'
    elif ((channel == '1C')or(channel == '2C')):
       distfile='jwst_miri_mrs12C_distortion_flt4.asdf'
       regfile='jwst_miri_mrs12C_regions_flt4.asdf'
       specfile='jwst_miri_mrs12C_specwcs_flt4.asdf'
    elif ((channel == '3C')or(channel == '4C')):
       distfile='jwst_miri_mrs34C_distortion_flt4.asdf'
       regfile='jwst_miri_mrs34C_regions_flt4.asdf'
       specfile='jwst_miri_mrs34C_specwcs_flt4.asdf'
    else:
       print('Failure!')

    # Try looking for the files in the expected location
    rootdir=os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))
    rootdir=os.path.join(rootdir,'data/crds/flt4/')
...
mrs_ref_data = {
    '1A': {'x': np.array([ 76., 354.]),
           ...
           'lam': np.array([5.35087972, 5.51561288]),
    ...
    '1B': {'x': np.array([ 76., 355.]),
           ...
           'lam': np.array([6.17986771, 6.37069947]),
    ...
    '1C': {'x': np.array([ 78., 356.]),
           ...
           'lam': np.array([7.13283532, 7.35239224]),
    ...
    '2A': {'x': np.array([574., 719.]),
           ...
           'lam': np.array([8.15998156, 8.44604981]),
    ...
    '2B': {'x': np.array([570., 715.]),
           ...
           'lam': np.array([9.42412363, 9.75587829]),
    ...
    '2C': {'x': np.array([573., 718.]),
           ...
           'lam': np.array([10.88445621, 11.26547378]),
    ...
    '3A': {'x': np.array([918., 827.]),
           ...
           'lam': np.array([12.55545529, 12.21699967]),
    ...
    '3B': {'x': np.array([919., 827.]),
           ...
           'beta': np.array([ 0.58472067, -1.754162  ]),
           'lam': np.array([14.5095554 , 14.11863415]),
    ...
    '3C': {'x': np.array([917., 826.]),
           ...
           'beta': np.array([ 0.58472067, -1.754162  ]),
           'lam': np.array([16.76050529, 16.30953938]),
    ...
    '4A': {'x': np.array([195., 232.]),
           ...
           'lam': np.array([19.46632903, 18.766802]),
    ...
    '4B': {'x': np.array([192., 229.]),
           ...
           'lam': np.array([22.74119887, 21.9272137]),
    ...
    '4C': {'x': np.array([194., 231.]),
           ...
           'lam': np.array([26.59809744, 25.64596776]),
